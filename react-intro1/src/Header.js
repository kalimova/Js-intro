    ...
    <nav className="flex items-center justify-between flex-wrap bg-teal p-6">
        ...
        <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
          <div className="text-sm lg:flex-grow">
            ...
            <a
              href="#responsive-header"
              className="button block mt-4 lg:inline-block lg:mt-0 text-teal-lighter hover:text-white"
            >
              SignIn
            </a>
          </div>
      ...
      <div class="min-h-screen bg-gray-800 flex items-center justify-center">
        <div class="bg-gray-100 w-full mx-4 p-4 rounded-xl md:w-1/2 lg:w-1/3">
          <div class="flex justify-between items center border-b border-gray-200 py-3">
            ...
            <div class="bg-gray-300 hover:bg-gray-500 cursor-pointer hover:text-gray-300 font-sans text-gray-500 w-8 h-8 flex items-center justify-center rounded-full">
              x
            </div>
          </div>
